export async function DisplaySitePlanInformation(sitePlanContainerClass) {
    const darkModeButton = document.querySelector('.darkMode');
    const sitePlanContainer = document.querySelector(sitePlanContainerClass);
    ...
    sitePlanContainer.appendChild(sitePlanHeader);
    sitePlanContainer.appendChild(detailsSection);
    sitePlanContainer.appendChild(colorSchemeSection);
    sitePlanContainer.appendChild(typographySection);
    sitePlanContainer.appendChild(wireframesSection);
}