export async function DisplayHomeInformation(homeContainerClass) {
    ...
    homeContainer.appendChild(sitePlanHeader);
    homeContainer.appendChild(detailsSection);
    homeContainer.appendChild(colorSchemeSection);
    homeContainer.appendChild(typographySection);
    homeContainer.appendChild(wireframesSection);
}