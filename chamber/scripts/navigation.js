...
const dirButtonElements = document.querySelectorAll('.directory-button');
...
dirButtonElements.forEach(element => element.classList.add('light'));
...
drkButton.addEventListener('click', () => {
    ...
    if (darkElement.classList.contains('light')) {
        ...
        dirButtonElements.forEach(element => element.classList.remove('light'));
